 ...
 */
  ...
  */
      ...
      return (
        <div>
          <div className={styles.description}>
            ...
            {utils.formatEther(cdBalance)} Web3 Star Tokens
            <br />
            {utils.formatEther(ethBalance)} Ether
            <br />
            {utils.formatEther(lpBalance)} Web3 Star LP tokens
          </div>
          <div>
            ...
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              <div>
                ...
                <input
                  type="number"
                  placeholder="Amount of Web3Star tokens"
                  onChange={(e) =>
                    setAddCDTokens(
              ...
              <div>
                ...
                <div className={styles.inputDiv}>
                  {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
                  {`You will need ${utils.formatEther(addCDTokens)} Web3 Star
                  Tokens`}
                </div>
                <button className={styles.button1} onClick={_addLiquidity}>
                  Add
            ...
            <div>
              ...
              <div className={styles.inputDiv}>
                ...
                {`You will get ${utils.formatEther(
                  removeCD
                )} Web3 Star Tokens and ${utils.formatEther(removeEther)} Eth`}
              </div>
      ...
      return (
        <div>
          ...
          >
            ...
            <option value="cryptoDevToken">Web3 Star Token</option>
          </select>
          <br />
          <div className={styles.inputDiv}>
            {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
  ...
  return (
    <div>
      <Head>
        <title>Web3 Stars</title>
        <meta name="description" content="Exchange-Dapp" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Web3 Stars Exchange!</h1>
          <div className={styles.description}>
            Exchange Ethereum &#60;&#62; Web3Star Tokens
          </div>
          <div>
            <button
